// ======================================================================
// test_draw_altium.v generated from TopDesign.cysch
// 09/08/2022 at 18:00
...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("36693f33-6298-4327-a2ad-f361ec34363f/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("119047619.047619"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("75ed4030-cf5a-4fac-b5d8-2e60b95aebab"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__analog_3_net;
	wire [0:0] tmpFB_0__analog_3_net;
	wire [0:0] tmpIO_0__analog_3_net;
	wire [0:0] tmpINTERRUPT_0__analog_3_net;
	electrical [0:0] tmpSIOVREF__analog_3_net;

	cy_psoc3_pins_v1_10
		#(.id("64c90cc4-4179-427f-a146-fb4812ca8c10"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		analog_3
		 (.oe(tmpOE__analog_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__analog_3_net[0:0]}),
		  .analog({Net_38}),
		  .io({tmpIO_0__analog_3_net[0:0]}),
		  .siovref(tmpSIOVREF__analog_3_net),
		  .interrupt({tmpINTERRUPT_0__analog_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analog_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__analog_4_net;
	wire [0:0] tmpFB_0__analog_4_net;
	wire [0:0] tmpIO_0__analog_4_net;
	wire [0:0] tmpINTERRUPT_0__analog_4_net;
	electrical [0:0] tmpSIOVREF__analog_4_net;

	cy_psoc3_pins_v1_10
		#(.id("366ae0ac-8e7e-4b1c-988d-93636686a104"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		analog_4
		 (.oe(tmpOE__analog_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__analog_4_net[0:0]}),
		  .analog({Net_39}),
		  .io({tmpIO_0__analog_4_net[0:0]}),
		  .siovref(tmpSIOVREF__analog_4_net),
		  .interrupt({tmpINTERRUPT_0__analog_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analog_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_ROLE_1_net;
	wire [0:0] tmpFB_0__OUT_ROLE_1_net;
	wire [0:0] tmpIO_0__OUT_ROLE_1_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ROLE_1_net;
	electrical [0:0] tmpSIOVREF__OUT_ROLE_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ROLE_1
		 (.oe(tmpOE__OUT_ROLE_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_ROLE_1_net[0:0]}),
		  .io({tmpIO_0__OUT_ROLE_1_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ROLE_1_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ROLE_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ROLE_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_ROLE_2_net;
	wire [0:0] tmpFB_0__OUT_ROLE_2_net;
	wire [0:0] tmpIO_0__OUT_ROLE_2_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ROLE_2_net;
	electrical [0:0] tmpSIOVREF__OUT_ROLE_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d6f49765-bd6f-4d25-bbd8-cee38773344b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ROLE_2
		 (.oe(tmpOE__OUT_ROLE_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_ROLE_2_net[0:0]}),
		  .io({tmpIO_0__OUT_ROLE_2_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ROLE_2_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ROLE_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ROLE_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_ROLE_3_net;
	wire [0:0] tmpFB_0__OUT_ROLE_3_net;
	wire [0:0] tmpIO_0__OUT_ROLE_3_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ROLE_3_net;
	electrical [0:0] tmpSIOVREF__OUT_ROLE_3_net;

	cy_psoc3_pins_v1_10
		#(.id("039c2395-acb3-455a-ba59-2bf2b35749a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ROLE_3
		 (.oe(tmpOE__OUT_ROLE_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_ROLE_3_net[0:0]}),
		  .io({tmpIO_0__OUT_ROLE_3_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ROLE_3_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ROLE_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ROLE_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_ROLE_4_net;
	wire [0:0] tmpFB_0__OUT_ROLE_4_net;
	wire [0:0] tmpIO_0__OUT_ROLE_4_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ROLE_4_net;
	electrical [0:0] tmpSIOVREF__OUT_ROLE_4_net;

	cy_psoc3_pins_v1_10
		#(.id("ec66ef88-e3d1-45ad-8ea5-4bee075f53ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ROLE_4
		 (.oe(tmpOE__OUT_ROLE_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_ROLE_4_net[0:0]}),
		  .io({tmpIO_0__OUT_ROLE_4_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ROLE_4_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ROLE_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ROLE_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_ROLE_5_net;
	wire [0:0] tmpFB_0__OUT_ROLE_5_net;
	wire [0:0] tmpIO_0__OUT_ROLE_5_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ROLE_5_net;
	electrical [0:0] tmpSIOVREF__OUT_ROLE_5_net;

	cy_psoc3_pins_v1_10
		#(.id("7a746fc9-9374-486e-a25d-7ec9b2275eed"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ROLE_5
		 (.oe(tmpOE__OUT_ROLE_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_ROLE_5_net[0:0]}),
		  .io({tmpIO_0__OUT_ROLE_5_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ROLE_5_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ROLE_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ROLE_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_ROLE_6_net;
	wire [0:0] tmpFB_0__OUT_ROLE_6_net;
	wire [0:0] tmpIO_0__OUT_ROLE_6_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ROLE_6_net;
	electrical [0:0] tmpSIOVREF__OUT_ROLE_6_net;

	cy_psoc3_pins_v1_10
		#(.id("7dbba0e4-9aab-49c1-b9a0-065553516e80"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ROLE_6
		 (.oe(tmpOE__OUT_ROLE_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_ROLE_6_net[0:0]}),
		  .io({tmpIO_0__OUT_ROLE_6_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ROLE_6_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ROLE_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ROLE_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("96320aa2-bc25-4cca-9ea2-b47c79547b2d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f210a428-8adf-4fce-94a1-7b06121b8a91"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("20bac4ea-e2e7-41ac-90f5-52fd2d7b3638"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpFB_0__ENCODER_1_net;
	...
	wire [0:0] tmpOE__OUT_M_1_net;
	wire [0:0] tmpFB_0__OUT_M_1_net;
	wire [0:0] tmpIO_0__OUT_M_1_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_1_net;
	electrical [0:0] tmpSIOVREF__OUT_M_1_net;

	cy_psoc3_pins_v1_10
		#(.id("dfca2b64-f515-43df-b6f9-b289e888da7c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_1
		 (.oe(tmpOE__OUT_M_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_1_net[0:0]}),
		  .io({tmpIO_0__OUT_M_1_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_1_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_M_2_net;
	wire [0:0] tmpFB_0__OUT_M_2_net;
	wire [0:0] tmpIO_0__OUT_M_2_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_2_net;
	electrical [0:0] tmpSIOVREF__OUT_M_2_net;

	cy_psoc3_pins_v1_10
		#(.id("72bbc3f2-016d-4210-897a-a391098474ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_2
		 (.oe(tmpOE__OUT_M_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_2_net[0:0]}),
		  .io({tmpIO_0__OUT_M_2_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_2_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_M_3_net;
	wire [0:0] tmpFB_0__OUT_M_3_net;
	wire [0:0] tmpIO_0__OUT_M_3_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_3_net;
	electrical [0:0] tmpSIOVREF__OUT_M_3_net;

	cy_psoc3_pins_v1_10
		#(.id("d732c803-b0f4-484d-a315-5dced2fa91e1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_3
		 (.oe(tmpOE__OUT_M_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_3_net[0:0]}),
		  .io({tmpIO_0__OUT_M_3_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_3_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_M_4_net;
	wire [0:0] tmpFB_0__OUT_M_4_net;
	wire [0:0] tmpIO_0__OUT_M_4_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_4_net;
	electrical [0:0] tmpSIOVREF__OUT_M_4_net;

	cy_psoc3_pins_v1_10
		#(.id("3516d04d-4447-4c2a-8e11-13ef8a54d76a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_4
		 (.oe(tmpOE__OUT_M_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_4_net[0:0]}),
		  .io({tmpIO_0__OUT_M_4_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_4_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_M_5_net;
	wire [0:0] tmpFB_0__OUT_M_5_net;
	wire [0:0] tmpIO_0__OUT_M_5_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_5_net;
	electrical [0:0] tmpSIOVREF__OUT_M_5_net;

	cy_psoc3_pins_v1_10
		#(.id("cd29888e-4927-42dc-9141-2bcc6731e493"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_5
		 (.oe(tmpOE__OUT_M_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_5_net[0:0]}),
		  .io({tmpIO_0__OUT_M_5_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_5_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_M_6_net;
	wire [0:0] tmpFB_0__OUT_M_6_net;
	wire [0:0] tmpIO_0__OUT_M_6_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_6_net;
	electrical [0:0] tmpSIOVREF__OUT_M_6_net;

	cy_psoc3_pins_v1_10
		#(.id("a107554b-22b5-4e2e-a09a-3227aa15b62e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_6
		 (.oe(tmpOE__OUT_M_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_6_net[0:0]}),
		  .io({tmpIO_0__OUT_M_6_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_6_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUT_UP_net;
	wire [0:0] tmpFB_0__BUT_UP_net;
	wire [0:0] tmpIO_0__BUT_UP_net;
	wire [0:0] tmpINTERRUPT_0__BUT_UP_net;
	electrical [0:0] tmpSIOVREF__BUT_UP_net;

	cy_psoc3_pins_v1_10
		#(.id("fcfacc82-f8a1-46f7-be6e-9c3cf1e08bb2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUT_UP
		 (.oe(tmpOE__BUT_UP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_UP_net[0:0]}),
		  .io({tmpIO_0__BUT_UP_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_UP_net),
		  .interrupt({tmpINTERRUPT_0__BUT_UP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_UP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUT_DOWN_net;
	wire [0:0] tmpFB_0__BUT_DOWN_net;
	wire [0:0] tmpIO_0__BUT_DOWN_net;
	wire [0:0] tmpINTERRUPT_0__BUT_DOWN_net;
	electrical [0:0] tmpSIOVREF__BUT_DOWN_net;

	cy_psoc3_pins_v1_10
		#(.id("37646bee-41ca-4196-b63f-da266fff9aef"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUT_DOWN
		 (.oe(tmpOE__BUT_DOWN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_DOWN_net[0:0]}),
		  .io({tmpIO_0__BUT_DOWN_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_DOWN_net),
		  .interrupt({tmpINTERRUPT_0__BUT_DOWN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_DOWN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUT_SET_1_net;
	wire [0:0] tmpFB_0__BUT_SET_1_net;
	wire [0:0] tmpIO_0__BUT_SET_1_net;
	wire [0:0] tmpINTERRUPT_0__BUT_SET_1_net;
	electrical [0:0] tmpSIOVREF__BUT_SET_1_net;

	cy_psoc3_pins_v1_10
		#(.id("5a21dc54-98d4-4a61-834b-75bf2032c2d1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUT_SET_1
		 (.oe(tmpOE__BUT_SET_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_SET_1_net[0:0]}),
		  .io({tmpIO_0__BUT_SET_1_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_SET_1_net),
		  .interrupt({tmpINTERRUPT_0__BUT_SET_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_SET_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUT_SET_2_net;
	wire [0:0] tmpFB_0__BUT_SET_2_net;
	wire [0:0] tmpIO_0__BUT_SET_2_net;
	wire [0:0] tmpINTERRUPT_0__BUT_SET_2_net;
	electrical [0:0] tmpSIOVREF__BUT_SET_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0b09535a-0532-4f16-af73-f7b7931e3e54"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUT_SET_2
		 (.oe(tmpOE__BUT_SET_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_SET_2_net[0:0]}),
		  .io({tmpIO_0__BUT_SET_2_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_SET_2_net),
		  .interrupt({tmpINTERRUPT_0__BUT_SET_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_SET_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUT_TURN_ON_net;
	wire [0:0] tmpFB_0__BUT_TURN_ON_net;
	wire [0:0] tmpIO_0__BUT_TURN_ON_net;
	wire [0:0] tmpINTERRUPT_0__BUT_TURN_ON_net;
	electrical [0:0] tmpSIOVREF__BUT_TURN_ON_net;

	cy_psoc3_pins_v1_10
		#(.id("1cc20ad4-b318-450d-b86c-c6dc55ff79da"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUT_TURN_ON
		 (.oe(tmpOE__BUT_TURN_ON_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_TURN_ON_net[0:0]}),
		  .io({tmpIO_0__BUT_TURN_ON_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_TURN_ON_net),
		  .interrupt({tmpINTERRUPT_0__BUT_TURN_ON_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_TURN_ON_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUT_TURN_OFF_net;
	wire [0:0] tmpFB_0__BUT_TURN_OFF_net;
	wire [0:0] tmpIO_0__BUT_TURN_OFF_net;
	wire [0:0] tmpINTERRUPT_0__BUT_TURN_OFF_net;
	electrical [0:0] tmpSIOVREF__BUT_TURN_OFF_net;

	cy_psoc3_pins_v1_10
		#(.id("c1f4d6c7-d3a4-44f5-acf7-f0b1b7c7bbb4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUT_TURN_OFF
		 (.oe(tmpOE__BUT_TURN_OFF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_TURN_OFF_net[0:0]}),
		  .io({tmpIO_0__BUT_TURN_OFF_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_TURN_OFF_net),
		  .interrupt({tmpINTERRUPT_0__BUT_TURN_OFF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_TURN_OFF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_SEG_3_net;
	wire [0:0] tmpFB_0__LED_SEG_3_net;
	wire [0:0] tmpIO_0__LED_SEG_3_net;
	wire [0:0] tmpINTERRUPT_0__LED_SEG_3_net;
	electrical [0:0] tmpSIOVREF__LED_SEG_3_net;

	cy_psoc3_pins_v1_10
		#(.id("9347b4b2-e032-4a25-9c96-9820f9039666"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SEG_3
		 (.oe(tmpOE__LED_SEG_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SEG_3_net[0:0]}),
		  .io({tmpIO_0__LED_SEG_3_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SEG_3_net),
		  .interrupt({tmpINTERRUPT_0__LED_SEG_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_SEG_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_SEG_2_net;
	wire [0:0] tmpFB_0__LED_SEG_2_net;
	wire [0:0] tmpIO_0__LED_SEG_2_net;
	wire [0:0] tmpINTERRUPT_0__LED_SEG_2_net;
	electrical [0:0] tmpSIOVREF__LED_SEG_2_net;

	cy_psoc3_pins_v1_10
		#(.id("4e55cb53-0b2e-43cf-a641-79a594e396e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SEG_2
		 (.oe(tmpOE__LED_SEG_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SEG_2_net[0:0]}),
		  .io({tmpIO_0__LED_SEG_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SEG_2_net),
		  .interrupt({tmpINTERRUPT_0__LED_SEG_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_SEG_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_SEG_1_net;
	wire [0:0] tmpFB_0__LED_SEG_1_net;
	wire [0:0] tmpIO_0__LED_SEG_1_net;
	wire [0:0] tmpINTERRUPT_0__LED_SEG_1_net;
	electrical [0:0] tmpSIOVREF__LED_SEG_1_net;

	cy_psoc3_pins_v1_10
		#(.id("1e3e4408-b52f-456e-a097-4c6268f0c5c0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SEG_1
		 (.oe(tmpOE__LED_SEG_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SEG_1_net[0:0]}),
		  .io({tmpIO_0__LED_SEG_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SEG_1_net),
		  .interrupt({tmpINTERRUPT_0__LED_SEG_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_SEG_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_SEG_4_net;
	wire [0:0] tmpFB_0__LED_SEG_4_net;
	wire [0:0] tmpIO_0__LED_SEG_4_net;
	wire [0:0] tmpINTERRUPT_0__LED_SEG_4_net;
	electrical [0:0] tmpSIOVREF__LED_SEG_4_net;

	cy_psoc3_pins_v1_10
		#(.id("1a2a46fd-6705-4446-9947-3042828f85ee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SEG_4
		 (.oe(tmpOE__LED_SEG_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SEG_4_net[0:0]}),
		  .io({tmpIO_0__LED_SEG_4_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SEG_4_net),
		  .interrupt({tmpINTERRUPT_0__LED_SEG_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_SEG_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_SDA_net;
	wire [0:0] tmpFB_0__LED_SDA_net;
	wire [0:0] tmpIO_0__LED_SDA_net;
	wire [0:0] tmpINTERRUPT_0__LED_SDA_net;
	electrical [0:0] tmpSIOVREF__LED_SDA_net;

	cy_psoc3_pins_v1_10
		#(.id("41ce1124-3124-4da7-84cc-a0300e169d58"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SDA
		 (.oe(tmpOE__LED_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SDA_net[0:0]}),
		  .io({tmpIO_0__LED_SDA_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SDA_net),
		  .interrupt({tmpINTERRUPT_0__LED_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_SCK_net;
	wire [0:0] tmpFB_0__LED_SCK_net;
	wire [0:0] tmpIO_0__LED_SCK_net;
	wire [0:0] tmpINTERRUPT_0__LED_SCK_net;
	electrical [0:0] tmpSIOVREF__LED_SCK_net;

	cy_psoc3_pins_v1_10
		#(.id("c7a6cd0f-a4e6-4f75-b869-98890fba86aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SCK
		 (.oe(tmpOE__LED_SCK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SCK_net[0:0]}),
		  .io({tmpIO_0__LED_SCK_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SCK_net),
		  .interrupt({tmpINTERRUPT_0__LED_SCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_SCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_LATCH_net;
	wire [0:0] tmpFB_0__LED_LATCH_net;
	wire [0:0] tmpIO_0__LED_LATCH_net;
	wire [0:0] tmpINTERRUPT_0__LED_LATCH_net;
	electrical [0:0] tmpSIOVREF__LED_LATCH_net;

	cy_psoc3_pins_v1_10
		#(.id("dc50e4cd-a9aa-4643-9553-22745084c6e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_LATCH
		 (.oe(tmpOE__LED_LATCH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_LATCH_net[0:0]}),
		  .io({tmpIO_0__LED_LATCH_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_LATCH_net),
		  .interrupt({tmpINTERRUPT_0__LED_LATCH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_LATCH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c973e3b9-04b2-4837-ab72-7bd1fc07554c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__OUT_M_7_net;
	wire [0:0] tmpFB_0__OUT_M_7_net;
	wire [0:0] tmpIO_0__OUT_M_7_net;
	wire [0:0] tmpINTERRUPT_0__OUT_M_7_net;
	electrical [0:0] tmpSIOVREF__OUT_M_7_net;

	cy_psoc3_pins_v1_10
		#(.id("61a365c9-c78c-40fd-8af2-7f591aec8b78"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_M_7
		 (.oe(tmpOE__OUT_M_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUT_M_7_net[0:0]}),
		  .io({tmpIO_0__OUT_M_7_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_M_7_net),
		  .interrupt({tmpINTERRUPT_0__OUT_M_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_M_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__analog_5_net;
	wire [0:0] tmpFB_0__analog_5_net;
	wire [0:0] tmpIO_0__analog_5_net;
	wire [0:0] tmpINTERRUPT_0__analog_5_net;
	electrical [0:0] tmpSIOVREF__analog_5_net;

	cy_psoc3_pins_v1_10
		#(.id("64feb651-a393-4146-a578-fdee742ce820"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		analog_5
		 (.oe(tmpOE__analog_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__analog_5_net[0:0]}),
		  .analog({Net_94}),
		  .io({tmpIO_0__analog_5_net[0:0]}),
		  .siovref(tmpSIOVREF__analog_5_net),
		  .interrupt({tmpINTERRUPT_0__analog_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analog_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__analog_6_net;
	wire [0:0] tmpFB_0__analog_6_net;
	wire [0:0] tmpIO_0__analog_6_net;
	wire [0:0] tmpINTERRUPT_0__analog_6_net;
	electrical [0:0] tmpSIOVREF__analog_6_net;

	cy_psoc3_pins_v1_10
		#(.id("2742e97a-2a3c-491b-aef2-2d0b79d58123"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		analog_6
		 (.oe(tmpOE__analog_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__analog_6_net[0:0]}),
		  .analog({Net_96}),
		  .io({tmpIO_0__analog_6_net[0:0]}),
		  .siovref(tmpSIOVREF__analog_6_net),
		  .interrupt({tmpINTERRUPT_0__analog_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analog_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
