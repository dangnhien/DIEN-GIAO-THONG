...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x0000005Fu);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x0000005Fu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x001B6DB1u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x0000005Fu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x0000005Fu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC), 0x001B6DB6u);

	/* IOPINS0_5 Starting address: CYDEV_GPIO_PRT5_BASE */
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00008249u);
